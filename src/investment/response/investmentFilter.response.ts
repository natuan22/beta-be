...
export class InvestmentFilterResponse {
  ...
  constructor(data?: InvestmentFilterResponse) {
    ...
    this.growthProfitBeforeRevenueSamePeriod =
      data?.growthProfitBeforeRevenueSamePeriod || 0;
    this.growthProfitAfterRevenue = data?.growthProfitAfterRevenue || 0;
    this.growthProfitAfterRevenueSamePeriod =
      data?.growthProfitAfterRevenueSamePeriod || 0;
    this.growthEPS = data?.growthEPS || 0;
    this.growthEPSSamePeriod = data?.growthEPSSamePeriod || 0;
    this.totalVol_AVG_5 = data?.totalVol_AVG_5
      ? data?.totalVol_AVG_5 / 1000000
      : 0;
    this.totalVol_AVG_10 = data?.totalVol_AVG_10
      ? data?.totalVol_AVG_10 / 1000000
      : 0;
    this.totalVol_MAX_5 = data?.totalVol_MAX_5
      ? data?.totalVol_MAX_5 / 1000000
      : 0;
    this.totalVol_MAX_10 = data?.totalVol_MAX_10
      ? data?.totalVol_MAX_10 / 1000000
      : 0;
    this.totalVol_MIN_5 = data?.totalVol_MIN_5
      ? data?.totalVol_MIN_5 / 1000000
      : 0;
    this.totalVol_MIN_10 = data?.totalVol_MIN_10
      ? data?.totalVol_MIN_10 / 1000000
      : 0;
