    ...
    return [
      {
        ...
        value:
          dg_co_phieu.dinh_gia_pe < 0
            ? dg_co_phieu.dinh_gia_pe * -1
            : dg_co_phieu.dinh_gia_pe,
        value_industry:
          dg_nganh.dinh_gia_pe < 0
            ? dg_nganh.dinh_gia_pe * -1
            : dg_nganh.dinh_gia_pe,
      },
      {
        name: 'Định giá theo P/B',
        value:
          dg_co_phieu.dinh_gia_pb < 0
            ? dg_co_phieu.dinh_gia_pb * -1
            : dg_co_phieu.dinh_gia_pb,
        value_industry:
          dg_nganh.dinh_gia_pb < 0
            ? dg_nganh.dinh_gia_pb * -1
            : dg_nganh.dinh_gia_pb,
      },
      {
      ...
      },
      {
        ...
        value:
          dg_co_phieu.dinh_gia_pe * 0.35 +
          dg_co_phieu.dinh_gia_pb * 0.35 +
          this.isNegativeNumber(dg_co_phieu.graham_1) * 0.05 +
          this.isNegativeNumber(dg_co_phieu.graham_2) * 0.05 +
          this.isNegativeNumber(dg_co_phieu.graham_3) * 0.05,
        value_industry:
          dg_nganh.dinh_gia_pe * 0.35 +
          dg_nganh.dinh_gia_pb * 0.35 +
          this.isNegativeNumber(dg_nganh.graham_1) * 0.05 +
          this.isNegativeNumber(dg_nganh.graham_2) * 0.05 +
          this.isNegativeNumber(dg_nganh.graham_3) * 0.05,
      },
      {
        name: 'Kháng cự',
