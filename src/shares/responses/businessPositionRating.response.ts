  ...
  static mapToList(
    ...
    const data = [
      {
        ...
        value: UtilCommonTemplate.checkStarCommon(
          quy_mo_doanh_thu + quy_mo_von_hoa + quy_mo_tai_san + quy_mo_loi_nhuan,
          4,
        ),
        child: [
          {
      ...
      },
      {
        ...
        value: UtilCommonTemplate.checkStarCommon(
          gd_5_phien + gd_10_phien + gd_20_phien + gd_50_phien,
          4,
        ),
        child: [
          {
      ...
      },
      {
        name: 'Thu hút đầu tư',
        value: UtilCommonTemplate.checkStarCommon(
          gia_tri_so_huu_khoi_ngoai + gia_tri_tang_truong_VCSH,
          2,
        ),
        child: [
          {
    ...
    const totalStarIndustry = UtilCommonTemplate.checkStarCommon(
      UtilCommonTemplate.checkStarCommonV2(
        quy_mo_doanh_thu_industry +
          quy_mo_tai_san_industry +
          quy_mo_loi_nhuan_industry +
          quy_mo_von_hoa_industry,
        4,
      ) +
        UtilCommonTemplate.checkStarCommonV2(
          gd_5_phien_industry +
            gd_10_phien_industry +
            gd_20_phien_industry +
            gd_50_phien_industry,
          4,
        ) +
        UtilCommonTemplate.checkStarCommonV2(
          gia_tri_so_huu_khoi_ngoai_industry +
            gia_tri_tang_truong_VCSH_industry,
          2,
        ),
      3,
    );
    const totalStarAll = UtilCommonTemplate.checkStarCommon(
      UtilCommonTemplate.checkStarCommonV2(
        quy_mo_doanh_thu_all +
          quy_mo_tai_san_all +
          quy_mo_loi_nhuan_all +
          quy_mo_von_hoa_all,
        4,
      ) +
        UtilCommonTemplate.checkStarCommonV2(
          gd_5_phien_all + gd_10_phien_all + gd_20_phien_all + gd_50_phien_all,
          4,
        ) +
        UtilCommonTemplate.checkStarCommonV2(
          gia_tri_so_huu_khoi_ngoai_all + gia_tri_tang_truong_VCSH_all,
          2,
        ),
      3,
    );
