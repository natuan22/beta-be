...
export class FinancialHealthRatingNHResponse {
  static mapToList(
    star: IFinanceHealthNH,
    star_industry: IFinanceHealthNH,
    starAll: IFinanceHealthAll,
  ) {
    const data = [
      {
        name: 'Thanh khoản',
        value: UtilCommonTemplate.checkStarCommon(
          star.LFR + star.LTR + star.CAR + star.LAR_AR,
          4,
        ),
        child: [
          {
      ...
      },
      {
        ...
        value: UtilCommonTemplate.checkStarCommon(
          star.NPLR + star.NDR + star.LLP_NPL + star.NPL_TR,
          4,
        ),
        child: [
          {
      ...
      },
      {
        name: 'Cơ cấu tài sản',
        value: UtilCommonTemplate.checkStarCommon(
          star.LAR_EAA + star.LAR_TR + star.DDA_EAA + star.LDR,
          4,
        ),
        child: [
          {
      ...
      },
      {
        ...
        value: UtilCommonTemplate.checkStarCommon(
          star.NIM + star.COF + star.YOEA + star.NPI_AP,
          4,
        ),
        child: [
          {
    ...
    return {
      ...
      totalStarAll: UtilCommonTemplate.checkStarCommon(
        UtilCommonTemplate.checkStarCommon(
          ...
          UtilCommonTemplate.checkStarCommon(
            starAll.FAT + starAll.ATR + starAll.CTR + starAll.CT,
            4,
          ) +
          UtilCommonTemplate.checkStarCommon(
            starAll.GPM + starAll.NPM + starAll.ROA + starAll.ROE,
            4,
          ),
        4,
      ),
