...
export class StockNewsResponse {
  ...
  @ApiProperty({
    ...
    example:
      'https://cafefcdn.com/zoom/250_156/203337114487263232/2023/3/7/photo1678154031397-1678154031527819122980.jpg',
  })
  Img: string;
  ...
  constructor(data?: StockNewsResponse | any) {
    this.TickerInNews = data?.TickerInNews
      ? data?.TickerInNews.split(', ')
      : [];
